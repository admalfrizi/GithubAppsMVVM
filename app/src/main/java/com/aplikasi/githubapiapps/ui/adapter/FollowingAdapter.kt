...
class FollowingAdapter(private val context : Context, private var userList: List<ResponseUsersModel>) :
    RecyclerView.Adapter<FollowingAdapter.FollowingViewHolder>()
{
    inner class FollowingViewHolder(val binding: UserListViewBinding): RecyclerView.ViewHolder(binding.root)
